<template>
  <v-form ref="form" v-model="validInput" data-testid="bet-input">
    ...
    <v-row no-gutters class="mb-4" align="center" justify="center">
      ...
      <v-col v-else-if="currentUsersBet && editingEnabled" cols="6">
        <v-btn
          color="grey lighten-2"
          light
          v-bind="defaultButtonProps"
        ...
        <v-btn
          ...
          color="primary"
          v-bind="defaultButtonProps"
          :dark="!hasAlreadyStarted || validInput"
      ...
      <v-col v-else cols="6">
        <v-btn
          ...
          color="primary"
          v-bind="defaultButtonProps"
          :light="!hasAlreadyStarted && validInput && !sendingRequest"
